...
void main() {
  ...
  group('AssetNoteTemplateDataSource', () {
    test('loads built-in pathology templates from assets', () async {
      ...
      final pathologyKeys =
          templates.map((template) => template.pathologyKey).toSet();
      expect(pathologyKeys.length, templates.length);
    ...
    test('each template has complete SOAP sections', () async {
